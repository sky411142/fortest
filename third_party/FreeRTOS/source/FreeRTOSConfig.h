...
#define configTOTAL_HEAP_SIZE			( ( size_t ) ( 40 * 1024) )  //5000
#define configMAX_TASK_NAME_LEN			( 12 )  //task appear 
#define configUSE_TRACE_FACILITY		1
#define configUSE_16_BIT_TICKS			0
#define configIDLE_SHOULD_YIELD			0
#define configUSE_CO_ROUTINES 			0
#define configUSE_MUTEXES			1
#define configUSE_RECURSIVE_MUTEXES		1  //0   on/off recursive mutex
